            ...
            <div class=" panel-default" id="searchDiv">
              <div class="panel-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" onclick="save(2)">不通过</button>
                    <button type="button" class="btn btn-success" onclick="save(1)">通过</button>
                </div>
	            </form>
                </div>
                </div>
...
<script type="text/javascript">
    ...
    function save(checkFlag) {
        $.ajax({
            url: '${ctx}/contract/checkContracts.htm',
            async: true,//同步，会阻塞操作
            dataType: "json",
            type: 'POST',//PUT DELETE POST
            data: {
            	contractId : $("#fmContractId").val(),
            	checkFlag : checkFlag
            },
